...
const a = [1, 2, 3] as const //tableau const => ne peut être modifié

type ListItem = [string, number]

const a1: ListItem = ['tomate', 2]  //tuple constitué d'un string et d'un nombre. On ne peut pas ajouter d'element à a1
const b: (string | number)[] = ['tomate', 2] //tableau qui peut contenir des string ou des nombres
const b1: ListItem = ['banane', 3]
